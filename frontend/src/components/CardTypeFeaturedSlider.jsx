...
<a href="#" className="relative flex flex-col items-center rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    ...
    <div className="absolute flex flex-col justify-between p-4 leading-normal bg-tranparent">
        ...
        <p className="mb-3 font-normal text-gray-50 dark:text-gray-400">{ description } sdaf asdf asd fasdf asd fasd fasdf sadf sadf asdf sda fsdf asdf </p>
        <p className="mb-3 font-normal text-gray-50 dark:text-gray-400">${price}</p>
    </div>
</a>
